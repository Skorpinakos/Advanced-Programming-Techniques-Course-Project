...
async def upload(file: UploadFile = File(...)):
    try:
        ...
        print('step1')
        try:
            ocr_service.edit(list_of_concerns,'video_under_procces.mp4',quality_factor,file_mode,check_intervals)
    ...
    return FileResponse('store_output_video/video_under_procces.mp4.mp4',headers=response_dict,media_type="video/mp4")
